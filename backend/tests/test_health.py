...
def test_health_quote_service_failure(client: TestClient, monkeypatch):
...
def test_health_database_schema_exception(client: TestClient, monkeypatch):
...
def test_health_not_sqlite(client: TestClient, monkeypatch):
...
def test_health_in_memory_database(client: TestClient, monkeypatch):
...
def test_health_sqlite_with_query_string(client: TestClient, monkeypatch):
...
def test_health_data_dir_not_exist(client: TestClient, monkeypatch):
